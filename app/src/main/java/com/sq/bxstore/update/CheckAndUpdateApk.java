...
import com.sq.bxstore.update.VersionCheckAsyncTask.IVersionUpdate;
...
public class CheckAndUpdateApk implements IVersionUpdate {
    ...
    public static String TOUCHUS_APK = "BxStore.apk";
    private static final String PACKAGENAME = "com.sq.bxstore";
    /* 下载保存路径 */
...
//                msg.getData().putString("title", title);
            ...
            case DOWNLOAD_FINISH:
                if (cancelUpdate)
                    return;
                ToastTool.showLongBigToast(mActivity, R.string.download_success);
                // 取消下载对话框显示
                ...
                cancelUpdate = true;
                BXApplication.getInstance().downloadId = -1;
                break;
            ...
            case DOWNLOAD_ERROR:
                ToastTool.showLongBigToast(mActivity,
                        mActivity.getString(R.string.soft_update_download_error));
            ...
            case DOWNLOAD_ERROR_INSUFFICIENT_SPACE:
                ToastTool.showLongBigToast(mActivity, R.string.storageless_clear_toast);
                if (mDownloadDialog != null) {
                    mDownloadDialog.dismiss();
                }
                break;
            case SHOW_TOAST:
                ToastTool.showLongBigToast(mActivity, msg.obj.toString());
                break;
            default:
                break;
            }
    ...
    public void stopDownload() {
    	BXApplication.getInstance().cancelDownloadById();
    }
    ...
    private class downloadApkThread extends Thread {
        ...
        public void run() {
        	...
        	BXApplication.getInstance().downloadFileByUrl(BXApplication.UPDATE_URL, mHandler);
        }
    };
...
//         flag = "yes";
        if (flag.equals("force")) {
        	BXApplication.isNeedUpdate = true;
        ...
        BXApplication.isNeedUpdate = false;
        WaitTool.dismissDialog();
    }
}
