...
public class XListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		if (type == 1) {
//			mArrowImageView.setImageResource(R.drawable.progress_small_1);
	...
	private void refreshLastTime() {
		/////
		if (!TextUtils.isEmpty(BXApplication.lastTime)) {
			mHintLastTimeTextView.setText(BXApplication.lastTime);
		...
		BXApplication.lastTime = sdformat.format(date);
		/////
	}
