...
public class ChartTitleTextView extends TextView {
	...
	public ChartTitleTextView(Context context) {
		super(context);
		init(context);
	}

	public ChartTitleTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public ChartTitleTextView(Context context, AttributeSet attrs, int defStyle) {
