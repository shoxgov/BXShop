...
public class BannerView extends RelativeLayout {
	...
	private void init() {
        ...
        vParams.height = MainFragmentActivity.screenWidthPixels * 430 / 1903;
	...
	public void setAdList(List<AdvertsBean> list) {
		mList.clear();
		for (AdvertsBean ab : list) {
			mList.add(ab.getImgurl());
		}
		mItemCount = mList.size();
		initView();
	}
