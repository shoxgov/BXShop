...
public class ActivitiesListItemDefaultStyleView extends
	...
	public ActivitiesListItemDefaultStyleView(String catalogName,
	...
	@Override
	public View getView(int position, Context context, View convertView) {
		if (imageLoader == null) {
			imageLoader = BXApplication.getInstance().getImageLoader();
		}
		convertView = LayoutInflater.from(context).inflate(
				R.layout.list_itemview_default, null);
		TextView catalogNameTv = (TextView) convertView
				.findViewById(R.id.itemstyle_default_title);
		TextView name1Tv_1_1 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_1_1);
		TextView name2Tv_1_1 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_1_1);
		TextView name1Tv_1_2 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_1_2);
		TextView name2Tv_1_2 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_1_2);
		TextView name1Tv_1_3 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_1_3);
		TextView name2Tv_1_3 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_1_3);
		TextView name1Tv_2_1 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_2_1);
		TextView name2Tv_2_1 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_2_1);
		TextView name1Tv_2_2 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_2_2);
		TextView name2Tv_2_2 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_2_2);
		TextView name1Tv_2_3 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_2_3);
		TextView name2Tv_2_3 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_2_3);
		TextView name1Tv_3_1 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_3_1);
		TextView name2Tv_3_1 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_3_1);
		TextView name1Tv_3_2 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_3_2);
		TextView name2Tv_3_2 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_3_2);
		TextView name1Tv_3_3 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_3_3);
		TextView name2Tv_3_3 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_3_3);
		TextView name1Tv_3_4 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name1_3_4);
		TextView name2Tv_3_4 = (TextView) convertView
				.findViewById(R.id.itemstyle_default_name2_3_4);
		// /////////////////////////////////////////////////////
		ImageView iv_1_1 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_1_1);
		ImageView iv_1_2 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_1_2);
		ImageView iv_1_3 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_1_3);
		ImageView iv_2_1 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_2_1);
		ImageView iv_2_2 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_2_2);
		ImageView iv_2_3 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_2_3);
		ImageView iv_3_1 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_3_1);
		ImageView iv_3_2 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_3_2);
		ImageView iv_3_3 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_3_3);
		ImageView iv_3_4 = (ImageView) convertView
				.findViewById(R.id.itemstyle_default_img_3_4);
		convertView.findViewById(R.id.itemstyle_default_layout_1_0)
				.setOnClickListener(new ImageClickListener(context, 0));
		convertView.findViewById(R.id.itemstyle_default_layout_1_1)
				.setOnClickListener(new ImageClickListener(context, 0));
		convertView.findViewById(R.id.itemstyle_default_layout_1_2)
				.setOnClickListener(new ImageClickListener(context, 1));
		convertView.findViewById(R.id.itemstyle_default_layout_1_3)
				.setOnClickListener(new ImageClickListener(context, 2));
		convertView.findViewById(R.id.itemstyle_default_layout_2_0)
				.setOnClickListener(new ImageClickListener(context, 3));
		convertView.findViewById(R.id.itemstyle_default_layout_2_1)
				.setOnClickListener(new ImageClickListener(context, 3));
		convertView.findViewById(R.id.itemstyle_default_layout_2_2)
				.setOnClickListener(new ImageClickListener(context, 4));
		convertView.findViewById(R.id.itemstyle_default_layout_2_3)
				.setOnClickListener(new ImageClickListener(context, 5));
		convertView.findViewById(R.id.itemstyle_default_layout_3_1)
				.setOnClickListener(new ImageClickListener(context, 6));
		convertView.findViewById(R.id.itemstyle_default_layout_3_2)
				.setOnClickListener(new ImageClickListener(context, 7));
		convertView.findViewById(R.id.itemstyle_default_layout_3_3)
				.setOnClickListener(new ImageClickListener(context, 8));
		convertView.findViewById(R.id.itemstyle_default_layout_3_4)
				.setOnClickListener(new ImageClickListener(context, 9));
		...
		if (length > 3) {
			...
			convertView.findViewById(R.id.itemstyle_default_line_2)
					.setVisibility(View.GONE);
			convertView.findViewById(R.id.itemstyle_default_layout_2)
					.setVisibility(View.GONE);
			convertView.findViewById(R.id.itemstyle_default_line_3)
					.setVisibility(View.GONE);
			convertView.findViewById(R.id.itemstyle_default_layout_3)
					.setVisibility(View.GONE);
			return convertView;
		}
		if (length > 4) {
		...
		if (length > 9) {
			imageLoader.get(ads.get(9).getImgurl(), imageLoader
					.getImageListener(iv_3_4, R.mipmap.goods_list_item_bg,
							R.mipmap.goods_list_item_bg));
			name1Tv_3_4.setText(ads.get(9).getName());
			name2Tv_3_4.setText(ads.get(9).getMemo());
		} else {
			convertView.findViewById(R.id.itemstyle_default_layout_3_4)
					.setVisibility(View.GONE);
		}
